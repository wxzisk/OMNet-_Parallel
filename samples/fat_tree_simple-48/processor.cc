...
//             {
//                 // simtime_t d = packet_len * 8 / rate;
//                 // scheduleAt(simTime() + d, newmsg);
//                 // char msgname[10];
//                 // FatTreeMsg *slefmsg = new FatTreeMsg(msgname);
//                 // scheduleAt(simTime() + packets_gap, slefmsg);
//                 // delete slefmsg;
...
//             //EV<< "Processor" <<getIndex() <<"send the NO." << numFlitReceived++ << "packet"<<endl;
//             delete msg;
//         }
//     }
//     else
