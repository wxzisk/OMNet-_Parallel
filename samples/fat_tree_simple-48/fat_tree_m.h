 ...
 * {
 *     //����Ϊhead flit���е���Ϣ
 *     int src_ppid; //Դprocessor��physical id
 *     int dst_ppid; //Ŀ��processor��physical id
 * 
 *     //����Ϊÿ��flit�����е���Ϣ
 *     int hopCount = 0;
 *     int from_router_port; //��¼�ӵ�ǰ·��������һ���˿��յ���msg������һ��·���������
 * 
 *     long flitGenTime; //flit�Ĳ���ʱ��
 * 
 * }
 * </pre>
 */
class FatTreeMsg : public ::omnetpp::cMessage
{
  ...
  public:
    FatTreeMsg(const char *name=nullptr, short kind=0);
    FatTreeMsg(const FatTreeMsg& other);
    virtual ~FatTreeMsg();
    FatTreeMsg& operator=(const FatTreeMsg& other);
    virtual FatTreeMsg *dup() const override {return new FatTreeMsg(*this);}
